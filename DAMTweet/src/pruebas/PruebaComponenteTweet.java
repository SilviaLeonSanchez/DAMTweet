 ...
 * @author silvia
 */
public class PruebaComponenteTweet extends javax.swing.JFrame {

    /**
     * Creates new form PruebasComponentes
     */
    public PruebaComponenteTweet() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PruebaComponenteTweet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PruebaComponenteTweet().setVisible(true);
            }
        });
    }
